...
def classify_and_match(text: str):
    ...
    if RTX5050_RE.search(t):
        if price and price < 1700: return True, "gpu:rtx5050", "RTX 5050", price, "< 1700"
    ...
    if RTX5070_FAM.search(t):
        if price and price < 3860: return True, "gpu:rtx5070", "RTX 5070/5070 Ti", price, "< 3860"
        return False, "gpu:rtx5070", "RTX 5070/5070 Ti", price, ">= 3860 ou sem preço"
    if RX7600_RE.search(t):
        if price and price < 1700: return True, "gpu:rx7600", "RX 7600", price, "< 1700"
...
class Seen:
    ...
    def is_dup(self, msg_id):
        if msg_id in self.data: return True
        if len(self.data) > self.maxlen:
            for k in list(self.data)[:self.maxlen // 2]: del self.data[k]
